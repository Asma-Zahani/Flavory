...
import { Raleway, Libre_Baskerville, Dancing_Script, Great_Vibes, Fredoka, EB_Garamond } from "next/font/google";
import "../../globals.css";
...
export default function RootLayout({children}: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en">
      <body className={`${raleway.variable} ${libre.variable} ${dancing.variable} ${greatvibes.variable} ${fredoka.variable} ${garamond.variable} antialiased `} >

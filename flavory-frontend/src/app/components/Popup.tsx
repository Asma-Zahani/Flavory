...
export default function Popup ({setIsDelete, handleDelete} : {setIsDelete: React.Dispatch<React.SetStateAction<boolean>>; handleDelete: (e?: React.FormEvent) => void | Promise<void>;}) {
    return (
